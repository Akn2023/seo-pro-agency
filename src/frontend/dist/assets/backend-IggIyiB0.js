...
import { P as ProtocolError, T as TimeoutWaitingForResponseErrorCode, u as utf8ToBytes, E as ExternalError, M as MissingRootKeyErrorCode, C as Certificate, l as lookupResultToBuffer, R as RequestStatusResponseStatus, U as UnknownError, b as RequestStatusDoneNoReplyErrorCode, d as RejectError, e as CertifiedRejectErrorCode, f as UNREACHABLE_ERROR, I as InputError, g as InvalidReadStateRequestErrorCode, h as ReadRequestType, i as Principal, k as IDL, m as MissingCanisterIdErrorCode, H as HttpAgent, n as encode, Q as QueryResponseStatus, o as UncertifiedRejectErrorCode, p as isV3ResponseBody, q as isV2ResponseBody, s as UncertifiedRejectUpdateErrorCode, t as UnexpectedErrorCode, v as decode, S as Subscribable, w as pendingThenable, x as resolveEnabled, y as shallowEqualObjects, z as resolveStaleTime, A as noop, D as environmentManager, F as isValidTimeout, G as timeUntilStale, J as timeoutManager, K as focusManager, L as fetchState, N as replaceData, O as notifyManager, V as hashKey, W as getDefaultState, r as reactExports, X as shouldThrowError, Y as useQueryClient, _ as useInternetIdentity, $ as createActorWithConfig, c as createLucideIcon, a0 as Variant, a1 as Record, a2 as Opt, a3 as Vec, a4 as Service, a5 as Func, a6 as Null, a7 as Bool, a8 as Text, a9 as Nat, aa as Int } from "./index-BFTwSqlB.js";
...
const CheckoutSessionData = Record({
  "isSubscription": Bool,
  "isInstantPayment": Bool,
  "trialDays": Nat,
...
const PaymentMethod = Variant({ "stripe": Null });
const Timestamp = Int;
const TransactionView = Record({
...
const GetSubscriptionResult = Variant({
  "ok": SubscriptionView,
  "notFound": Null
});
const AuditReport = Record({
  "url": Text,
  "overallScore": Nat,
  "onPageScore": Nat,
...
const SubmitLeadResult = Variant({
  "ok": LeadId,
  "err": Text
});
Service({
  "cancelSubscription": Func([], [Bool], []),
  ...
  "getAllTransactions": Func([], [Vec(TransactionView)], []),
  "getLeads": Func([], [Vec(Lead)], ["query"]),
  "getMyTransactions": Func([], [Vec(TransactionView)], ["query"]),
  "getSubscription": Func([], [GetSubscriptionResult], ["query"]),
  "runSeoAudit": Func([Text], [AuditResult], []),
  "submitLead": Func([LeadInput], [SubmitLeadResult], [])
});
const idlFactory = ({ IDL: IDL2 }) => {
  const PlanType2 = IDL2.Variant({
    "webDesign": IDL2.Null,
    "enterprise": IDL2.Null,
    "starter": IDL2.Null,
    "professional": IDL2.Null
  });
  const CheckoutRequest2 = IDL2.Record({
    "isInstantPayment": IDL2.Bool,
    "plan": PlanType2
  });
  const CheckoutSessionData2 = IDL2.Record({
    "isSubscription": IDL2.Bool,
    "isInstantPayment": IDL2.Bool,
    "trialDays": IDL2.Nat,
    "discountedAmountCents": IDL2.Nat,
  ...
  const CheckoutSessionResult2 = IDL2.Variant({
    "ok": CheckoutSessionData2,
    "err": IDL2.Text
  });
  ...
  const PaymentMethod2 = IDL2.Variant({ "stripe": IDL2.Null });
  const Timestamp2 = IDL2.Int;
  const TransactionView2 = IDL2.Record({
  ...
  const SubscriptionView2 = IDL2.Record({
    ...
    "nextBillingDate": Timestamp2,
    "trialEndDate": Timestamp2,
    "isInstantPayment": IDL2.Bool,
    "createdAt": Timestamp2,
    "discountedAmountCents": IDL2.Nat,
    "amountCents": IDL2.Nat,
    "stripeSessionId": IDL2.Opt(IDL2.Text),
    "trialStartDate": Timestamp2,
    "planName": IDL2.Text,
    "planType": PlanType2
  });
  const GetSubscriptionResult2 = IDL2.Variant({
    "ok": SubscriptionView2,
    "notFound": IDL2.Null
  });
  const AuditReport2 = IDL2.Record({
    "url": IDL2.Text,
    "overallScore": IDL2.Nat,
    "onPageScore": IDL2.Nat,
    "recommendations": IDL2.Vec(IDL2.Text),
    "pageSpeedScore": IDL2.Nat,
    "metaTagsScore": IDL2.Nat,
    "technicalScore": IDL2.Nat,
    "mobileFriendlinessScore": IDL2.Nat,
    "backlinkScore": IDL2.Nat
  });
  const AuditResult2 = IDL2.Variant({ "ok": AuditReport2, "err": IDL2.Text });
  ...
  const SubmitLeadResult2 = IDL2.Variant({ "ok": LeadId2, "err": IDL2.Text });
  return IDL2.Service({
    "cancelSubscription": IDL2.Func([], [IDL2.Bool], []),
    "confirmPayment": IDL2.Func([IDL2.Text], [IDL2.Bool], []),
    "createCheckoutSession": IDL2.Func(
      [CheckoutRequest2],
      [CheckoutSessionResult2],
      []
    ),
    "getAllTransactions": IDL2.Func([], [IDL2.Vec(TransactionView2)], []),
    "getLeads": IDL2.Func([], [IDL2.Vec(Lead2)], ["query"]),
    "getMyTransactions": IDL2.Func([], [IDL2.Vec(TransactionView2)], ["query"]),
    "getSubscription": IDL2.Func([], [GetSubscriptionResult2], ["query"]),
    "runSeoAudit": IDL2.Func([IDL2.Text], [AuditResult2], []),
    "submitLead": IDL2.Func([LeadInput2], [SubmitLeadResult2], [])
  });
};
...
function from_candid_AuditResult_n25(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n26(_uploadFile, _downloadFile, value);
}
function from_candid_CheckoutSessionData_n7(_uploadFile, _downloadFile, value) {
  return from_candid_record_n8(_uploadFile, _downloadFile, value);
}
function from_candid_CheckoutSessionResult_n5(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n6(_uploadFile, _downloadFile, value);
}
function from_candid_GetSubscriptionResult_n19(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n20(_uploadFile, _downloadFile, value);
}
function from_candid_PaymentMethod_n16(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n17(_uploadFile, _downloadFile, value);
}
function from_candid_PlanType_n9(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n10(_uploadFile, _downloadFile, value);
}
function from_candid_SubmitLeadResult_n27(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n28(_uploadFile, _downloadFile, value);
}
function from_candid_SubscriptionStatus_n23(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n24(_uploadFile, _downloadFile, value);
}
function from_candid_SubscriptionView_n21(_uploadFile, _downloadFile, value) {
  return from_candid_record_n22(_uploadFile, _downloadFile, value);
}
function from_candid_TransactionStatus_n14(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n15(_uploadFile, _downloadFile, value);
}
function from_candid_TransactionView_n12(_uploadFile, _downloadFile, value) {
...
function from_candid_variant_n10(_uploadFile, _downloadFile, value) {
  return "webDesign" in value ? "webDesign" : "enterprise" in value ? "enterprise" : "starter" in value ? "starter" : "professional" in value ? "professional" : value;
}
...
function from_candid_variant_n17(_uploadFile, _downloadFile, value) {
  return "stripe" in value ? "stripe" : value;
}
...
function from_candid_variant_n24(_uploadFile, _downloadFile, value) {
  return "trial" in value ? "trial" : "active" in value ? "active" : "cancelled" in value ? "cancelled" : "pastDue" in value ? "pastDue" : value;
}
...
function to_candid_CheckoutRequest_n1(_uploadFile, _downloadFile, value) {
  return to_candid_record_n2(_uploadFile, _downloadFile, value);
}
function to_candid_PlanType_n3(_uploadFile, _downloadFile, value) {
